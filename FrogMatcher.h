...
class FrogMatcher {
  ...
  public:
          ...
          FrogMatcher() : ratio(0.65f), refineF(true), confidence(0.99), distance(3.0) {        
        ...
        // for all matches
          ...
          cv::Mat match(cv::Mat& image1, cv::Mat& image2, // input images 
				...
				// If there are no symmetrically matched points, skip the fundamental test (which will fail)
